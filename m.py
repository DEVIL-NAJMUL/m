...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :5.0\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : DEVIL \x1b[0m\x1b[1;97m]
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/DEVIL-NAJMUL/m/blob/main/approval.txt"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/DEVIL-NAJMUL/m/blob/main/approval.txt').text
			if basesplit in plr:
				key = basesplit
